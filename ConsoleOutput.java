...
public class ConsoleOutput {
	...
	public static void main(String[] args) {
		...
		System.out.println("안녕" + "하세요.");      //문자열 + 문자열 : + 는 연결 연산자.
		
			//출력시 정수, 실수 : ""를 처리하면 안 됨.
			// + : 더하기 연산자를 뜻함.
		...
		System.out.println( 1 + 2 + "문자");	// 3문자 (앞 + 는 연산, 뒤 +는 연결)
		...
		int a = 5;		// 정수형 a 변수에 정수값 5를 넣어라 
						...
						// ==	: 같다.
		System.out.println(a);    //변수를 출력할 때는 "" 를 넣으면 안 됨. 
		
		String b = "하세요";      //Spring  문자열 변수 선언시 사용
		...
		// %s	: 뒤의 문자열을 가지고 옵니다. 
		System.out.printf("%s은 %s가 매우 %s니다. ", "오늘", "날씨", "맑습");
		
		// %f : 문자열 뒤의 실수값 불러올 때 사용
		// %4.2f : 4: 전체 네 자리, 2 : 소숫점 이하 두 자리까지 잘라서 출력
		System.out.printf("나의 몸무게는 %f입니다. \n", 75.1234567);
		System.out.printf("나의 몸무게는 %4.2f입니다. \n", 75.1234567);     //75.12
		
		System.out.printf("오늘의 온도는 %f도 이고, %s %4.2f 입니다.", 17.33, "나의 몸무게는", 75.5);
